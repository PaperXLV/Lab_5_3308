...
function loadStatsPage()
{
	...
	{
		var cu_score = parseInt(table.rows[row_counter].cells[2].innerHTML, 10);
		var opp_score = parseInt(table.rows[row_counter].cells[3].innerHTML, 10);

		if (cu_score > opp_score)
		{
...
function loadPlayersPage()
{
	...
	for (playerIndex = 0; playerIndex < players.length; playerIndex++)
	{
		...
		anchor.href = "#";
		anchor.innerHTML = players[playerIndex].name;
		anchor.className = "dropdown-item";
		anchor.id = playerIndex;
		anchor.onclick = function()
		{
			switchPlayers(parseInt(this.id));
		};
		//switchPlayers(playerIndex);
